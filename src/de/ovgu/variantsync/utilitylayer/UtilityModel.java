...
/**
 * Receives requests of controller. Connection between utilityOperations and
 * controller.
 *
...
public class UtilityModel extends AbstractModel {
	...
	public void handleError(Exception e, String msg) {
		propertyChangeSupport.firePropertyChange(
				ControllerProperties.EXCEPTION_PROPERTY.getProperty(), msg,
				e.getMessage());
	}
	...
	public void handleError(String msg) {
		propertyChangeSupport.firePropertyChange(
				ControllerProperties.EXCEPTION_PROPERTY.getProperty(), null,
				msg);
	}
